...
if(isset($_POST["action"]))
{
	...
	{
			$output = array();
			$order_column = array('doctor_schedule_table.doctor_schedule_date', 'doctor_schedule_table.doctor_schedule_day', 'doctor_schedule_table.doctor_schedule_start_time', 'doctor_schedule_table.doctor_schedule_end_time', 'doctor_schedule_table.average_consulting_time');
			$main_query = "
			SELECT doctor_schedule_table.doctor_schedule_id, doctor_schedule_table.doctor_schedule_date, doctor_schedule_table.doctor_schedule_day, doctor_schedule_table.doctor_schedule_start_time, doctor_schedule_table.doctor_schedule_end_time, doctor_schedule_table.average_consulting_time, appointment_table.status
			...
			$search_query = '
			WHERE doctor_schedule_table.doctor_id = "'.$_SESSION["doctor_id"].'" AND 
			';
		...
		foreach($result as $row)
		{
			...
			// $sub_array[] = $row["doctor_schedule_id"];
        	...
        	$status = ($row['status'] == '') ? '<p style="color: green";>Available</p>' : '<p style="color: red";>Booked</p>';
