...
$object->query = "
SELECT * FROM specialization_table 
";
    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col" align="right">
                <button type="button" name="add_doctor" id="add_doctor" class="btn btn-success btn-circle btn-sm"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_email_address" id="doctor_email_address"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_date_of_birth" id="doctor_date_of_birth" readonly
                                    class="form-control" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_degree" id="doctor_degree" class="form-control" required
                                    data-parsley-trigger="keyup" />
                            </div>
                            <div class="col-md-6">
                                <label>Doctor Specialization <span class="text-danger">*</span></label>
                                <select name="specs_id" id="specs_id" class="form-control" required
                                    data-parsley-trigger="keyup">
                                    <?php
		      							foreach($result as $row)
		      							{
									?>
                                    <option value="<?php echo $row["specs_id"];?>">
                                        <?php echo $row["specs_name"];?>
                                    </option>
                                    <?php
										}
									?>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label>PRC No. <span class="text-danger">*</span></label>
                                <input type="text" name="doctor_prc" id="doctor_prc" class="form-control" required
                                    data-parsley-trigger="keyup" />
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="hidden_doctor_profile_image"
                                    id="hidden_doctor_profile_image" />
                            </div>
                        </div>
                    </div>
    ...
    $(document).on('click', '.edit_button', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#uploaded_image').html('<img src="' + data.doctor_profile_image +
                ...
                $('#specs_id').val(data.specs_id);
                $('#doctor_prc').val(data.doctor_prc);
                $('#clinic_name').val(data.clinic_name);
                $('#clinic_address').val(data.clinic_address);
    ...
    $(document).on('click', '.view_button', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html += '<tr><td colspan="2" class="text-center"><img src="' + data
                    .doctor_profile_image +
                    '" class="img-fluid img-thumbnail" width="150" /></td></tr>';

                html +=
                    '<tr><th width="40%" class="text-right">Doctor Email Address</th><td width="60%">' +
                    data.doctor_email_address + '</td></tr>';

                html +=
                    '<tr><th width="40%" class="text-right">Doctor Password</th><td width="60%">' +
                    data.doctor_password + '</td></tr>';

                html +=
                    '<tr><th width="40%" class="text-right">Doctor Name</th><td width="60%">' +
                    data.doctor_name + '</td></tr>';

                html +=
                    '<tr><th width="40%" class="text-right">Doctor Phone No.</th><td width="60%">' +
                    data.doctor_phone_no + '</td></tr>';

                html +=
                    '<tr><th width="40%" class="text-right">Doctor Address</th><td width="60%">' +
                    data.doctor_address + '</td></tr>';

                html +=
                    '<tr><th width="40%" class="text-right">Doctor Date of Birth</th><td width="60%">' +
                    data.doctor_date_of_birth + '</td></tr>';
                html +=
                    '<tr><th width="40%" class="text-right">Doctor Qualification</th><td width="60%">' +
                    data.doctor_degree + '</td></tr>';
				
                html +=
                    '<tr><th width="40%" class="text-right">Doctor Specialization</th><td width="60%">' +
                    data.specs_name + '</td></tr>';
